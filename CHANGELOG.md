...
StackGres 1.19.0-rc2 is out! :confetti_ball: :champagne: 

> This second release candidate solve a couple of issues and few hardenings

So, what you are waiting for to try this release and have a look to the future of StackGres! 

## :sparkles: NEW FEATURES AND CHANGES

* Improved lease locking by allowing retrying on retryable errors
...
`helm upgrade -n "stackgres" "stackgres-operator" https://stackgres.io/downloads/stackgres-k8s/stackgres/1.19.0-rc2/helm/stackgres-operator.tgz`

> IMPORTANT: This release is incompatible with previous `alpha` or `beta` versions. Upgrading from those versions will require uninstalling completely StackGres including all clusters and StackGres CRDs (those in `stackgres.io` group) first.

Thank you for all the issues created, ideas, and code contributions by the StackGres Community!

## :twisted_rightwards_arrows: [FULL LIST OF COMMITS](https://gitlab.com/ongresinc/stackgres/-/commits/1.19.0-rc2)

# :rocket: Release 1.19.0-rc1 (2026-06-19)

## :notepad_spiral: NOTES

StackGres 1.19.0-rc1 is out! :confetti_ball: :champagne: :fireworks: 

This release brings a big revamp of SGShardedCluster: the CRD version is bumped to `stackgres.io/v1beta1`, shards are now called workers and Citus query routers support has been added. Mutation and validation of resources are now also performed in the reconciliation cycle, allowing to disable webhooks, and operator locking now relies on the Kubernetes Leases API. Patroni can now be configured to use Pods FQDN instead of Pod IP with extra network and scheduling configuration, and new storage options allow to set `volumeAttributesClassName` and I/O throttling (`io.max`) for the data persistent volume. Reconciliation is now faster and more observable thanks to new ConfigMap, Secret and endpoints watchers, configurable caching with metrics and an optional deployed SSA snapshot. Day-2 operations are also improved: restart of an SGCluster no longer requires a direct connection to Patroni instances, a replica can be restored from a backup with `patronictl reinit` and a custom restore method can be set when replicating from an external instance. Finally, the SGCluster status now advertises the latest available Postgres and extensions versions.
...
`helm upgrade -n "stackgres" "stackgres-operator" https://stackgres.io/downloads/stackgres-k8s/stackgres/1.19.0-rc1/helm/stackgres-operator.tgz`

> IMPORTANT: This release is incompatible with previous `alpha` or `beta` versions. Upgrading from those versions will require uninstalling completely StackGres including all clusters and StackGres CRDs (those in `stackgres.io` group) first.

Thank you for all the issues created, ideas, and code contributions by the StackGres Community!

## :twisted_rightwards_arrows: [FULL LIST OF COMMITS](https://gitlab.com/ongresinc/stackgres/-/commits/1.19.0-rc1)

# :rocket: Release 1.18.8 (2026-05-25)

## :notepad_spiral: NOTES

StackGres 1.18.8 is out! :confetti_ball: :champagne: 

> This patch release fixes a few critical CVEs encountered in some of the images used by StackGres
...
`helm upgrade -n "stackgres" "stackgres-operator" https://stackgres.io/downloads/stackgres-k8s/stackgres/1.18.8/helm/stackgres-operator.tgz`

> IMPORTANT: This release is incompatible with previous `alpha` or `beta` versions. Upgrading from those versions will require uninstalling completely StackGres including all clusters and StackGres CRDs (those in `stackgres.io` group) first.

Thank you for all the issues created, ideas, and code contributions by the StackGres Community!

## :twisted_rightwards_arrows: [FULL LIST OF COMMITS](https://gitlab.com/ongresinc/stackgres/-/commits/1.18.8)

# :rocket: Release 1.18.7 (2026-05-21)

## :notepad_spiral: NOTES

StackGres 1.18.7 is out! :confetti_ball: :champagne: 
...
## :twisted_rightwards_arrows: [FULL LIST OF COMMITS](https://gitlab.com/ongresinc/stackgres/-/commits/1.18.7)

# :rocket: Release 1.18.6 (2026-02-27)

## :notepad_spiral: NOTES

StackGres 1.18.6 is out! :confetti_ball: :champagne: 
...
## :twisted_rightwards_arrows: [FULL LIST OF COMMITS](https://gitlab.com/ongresinc/stackgres/-/commits/1.18.6)
...
* Components updated (wal-g 3.0.8, OTEL contrib collector 0.144.0, FlunetBit 4.2.2, Babelfish Compass 2025.12, base images)
...
* Typo in `SGShardedCluster.spec.metadata.annotations.coordinatorAnyService`
* Some pods properties where ignored in sharded cluster overrides
* StatefulSet is reconcilied when backup Pod has wrong ownerReference
...
StackGres 1.18.3 is out! :confetti_ball: :champagne: :christmas_tree: 

This patch release aim to fix some issues and, in particular, a few related to the s3 SGObjectStorage type that were introduced in 1.18.0. See [#3092](https://gitlab.com/ongresinc/stackgres/-/issues/3092).
...
## :twisted_rightwards_arrows: [FULL LIST OF COMMITS](https://gitlab.com/ongresinc/stackgres/-/commits/1.18.3)

# :rocket: Release 1.18.2 (2025-12-09)

## :notepad_spiral: NOTES

StackGres 1.18.2 is out! :confetti_ball: :champagne: 

This patch release fix issues related to the update strategy feature introduced by version 1.18.0.

Please update as soon as possible in order to fix this issue! 
...
* Typo in the updateStrategy section of the CRD
* Non primary Pod with pending restart instance are not restarted
* Update strategy type only considered if annotation is also present
...
`helm upgrade -n "stackgres" "stackgres-operator" https://stackgres.io/downloads/stackgres-k8s/stackgres/1.18.2/helm/stackgres-operator.tgz`

> IMPORTANT: This release is incompatible with previous `alpha` or `beta` versions. Upgrading from those versions will require uninstalling completely StackGres including all clusters and StackGres CRDs (those in `stackgres.io` group) first.

Thank you for all the issues created, ideas, and code contributions by the StackGres Community!

## :twisted_rightwards_arrows: [FULL LIST OF COMMITS](https://gitlab.com/ongresinc/stackgres/-/commits/1.18.2)
...
StackGres 1.18.0 is out! :confetti_ball: :champagne: 
...
* PersistentVolumeClaim are not cleaned up after cluster deletion
* PodMonitor is continuously patched and not removed when requested by configuration
* Kubernetes cluster using IPv6 breaks replication initialization mode `FromReplica`
...
`helm upgrade -n "stackgres" "stackgres-operator" https://stackgres.io/downloads/stackgres-k8s/stackgres/1.18.0/helm/stackgres-operator.tgz`

> IMPORTANT: This release is incompatible with previous `alpha` or `beta` versions. Upgrading from those versions will require uninstalling completely StackGres including all clusters and StackGres CRDs (those in `stackgres.io` group) first.

Thank you for all the issues created, ideas, and code contributions by the StackGres Community!

## :twisted_rightwards_arrows: [FULL LIST OF COMMITS](https://gitlab.com/ongresinc/stackgres/-/commits/1.18.0)

# :rocket: Release 1.18.0-rc4 (2025-11-24)

## :notepad_spiral: NOTES

StackGres 1.18.0-rc4 is out! :confetti_ball: :champagne: 

> This release candidate fixes a few issues present in 1.18.0-rc3
...
* PodMonitor is continuously patched and not removed when requested by configuration
* Kubernetes cluster using IPv6 breaks replication initialization mode `FromReplica`
* Use target cluster labels for cleanup after major upgrade completed

## Web Console

* Allow to unset cronSchedule and backup paths for clusters and sharded clusters
* Remove default SGScript on clone
...
`helm upgrade -n "stackgres" "stackgres-operator" https://stackgres.io/downloads/stackgres-k8s/stackgres/1.18.0-rc4/helm/stackgres-operator.tgz`

> IMPORTANT: This release is incompatible with previous `alpha` or `beta` versions. Upgrading from those versions will require uninstalling completely StackGres including all clusters and StackGres CRDs (those in `stackgres.io` group) first.

Thank you for all the issues created, ideas, and code contributions by the StackGres Community!

## :twisted_rightwards_arrows: [FULL LIST OF COMMITS](https://gitlab.com/ongresinc/stackgres/-/commits/1.18.0-rc4)

# :rocket: Release 1.18.0-rc3 (2025-11-19)

## :notepad_spiral: NOTES

StackGres 1.18.0-rc3 is out! :confetti_ball: :champagne: 

> This release candidate fixes a few issues present in 1.18.0-rc2
...
`helm upgrade -n "stackgres" "stackgres-operator" https://stackgres.io/downloads/stackgres-k8s/stackgres/1.18.0-rc3/helm/stackgres-operator.tgz`

> IMPORTANT: This release is incompatible with previous `alpha` or `beta` versions. Upgrading from those versions will require uninstalling completely StackGres including all clusters and StackGres CRDs (those in `stackgres.io` group) first.

Thank you for all the issues created, ideas, and code contributions by the StackGres Community!

## :twisted_rightwards_arrows: [FULL LIST OF COMMITS](https://gitlab.com/ongresinc/stackgres/-/commits/1.18.0-rc3)
...
StackGres 1.17.4 is out! :confetti_ball: :champagne: 
...
* PostgreSQL 18.0 (previos patch didn't?! :face_palm:)
...
## :twisted_rightwards_arrows: [FULL LIST OF COMMITS](https://gitlab.com/ongresinc/stackgres/-/commits/1.17.4)

# :rocket: Release 1.17.3 (2025-10-17)

## :notepad_spiral: NOTES

StackGres 1.17.3 is out! :confetti_ball: :champagne: 

This release is not just a patch, it brings the long waited PostgreSQL 18 together with some fixes and updated images.
...
* `exec-with-env` failed in some cases
* Set Bootstrapped when upgrading from version previous to 1.16

## Web Console

* Fixed `generated-for-*` resources automatically created
...
`helm upgrade -n "stackgres" "stackgres-operator" https://stackgres.io/downloads/stackgres-k8s/stackgres/1.17.3/helm/stackgres-operator.tgz`

> IMPORTANT: This release is incompatible with previous `alpha` or `beta` versions. Upgrading from those versions will require uninstalling completely StackGres including all clusters and StackGres CRDs (those in `stackgres.io` group) first.

Thank you for all the issues created, ideas, and code contributions by the StackGres Community!

## :twisted_rightwards_arrows: [FULL LIST OF COMMITS](https://gitlab.com/ongresinc/stackgres/-/commits/1.17.3)
