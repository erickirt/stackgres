...
public class ShardingSphereShardedClusterUpdateWorkersSecret
    implements ResourceGenerator<StackGresShardedClusterContext> {

  final LabelFactoryForShardedCluster labelFactory;

  @Inject
  public ShardingSphereShardedClusterUpdateWorkersSecret(LabelFactoryForShardedCluster labelFactory) {
