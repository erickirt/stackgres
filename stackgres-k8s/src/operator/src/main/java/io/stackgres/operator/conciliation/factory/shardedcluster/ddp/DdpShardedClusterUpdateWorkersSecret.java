...
public class DdpShardedClusterUpdateWorkersSecret implements ResourceGenerator<StackGresShardedClusterContext> {

  final LabelFactoryForShardedCluster labelFactory;

  @Inject
  public DdpShardedClusterUpdateWorkersSecret(LabelFactoryForShardedCluster labelFactory) {
