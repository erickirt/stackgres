...
public class ShardedClusterWorkersDefaultInstanceProfile
  ...
  @Inject
  public ShardedClusterWorkersDefaultInstanceProfile(
  ...
  private StackGresProfile getDefaultProfile(StackGresShardedCluster cluster) {
    return new StackGresProfileBuilder()
        ...
        .withName(cluster.getSpec().getWorkers().getSgInstanceProfile())
