...
public class ShardingSphereShardedClusterWorkersScript implements ResourceGenerator<StackGresShardedClusterContext> {

  final LabelFactoryForShardedCluster labelFactory;

  @Inject
  public ShardingSphereShardedClusterWorkersScript(LabelFactoryForShardedCluster labelFactory) {
