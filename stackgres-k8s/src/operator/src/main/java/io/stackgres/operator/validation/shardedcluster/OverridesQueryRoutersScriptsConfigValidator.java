...
public class OverridesQueryRoutersScriptsConfigValidator implements ShardedClusterValidator {
  ...
  public void validate(StackGresShardedClusterReview review) throws ValidationFailed {
    if (review.getRequest().getOperation() == Operation.UPDATE
      ...
      for (var overrideShard : Optional.of(cluster.getSpec())
          ...
          .flatMap(List::stream)
          .toList()) {
        List<StackGresClusterManagedScriptEntry> scripts = Optional.of(overrideShard)
