...
public class ShardedClusterWorkersDefaultPostgresConfig
  ...
  @Inject
  public ShardedClusterWorkersDefaultPostgresConfig(
  ...
  private StackGresPostgresConfig getDefaultConfig(StackGresShardedCluster cluster) {
    return new StackGresPostgresConfigBuilder()
        ...
        .withName(cluster.getSpec().getWorkers().getConfigurations().getSgPostgresConfig())
