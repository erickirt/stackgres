...
public class DeployedResourcesFullCache implements DeployedResourcesCache {

  protected static final Logger LOGGER = LoggerFactory.getLogger(DeployedResourcesFullCache.class);
  ...
  public DeployedResourcesSnapshot createDeployedResourcesSnapshot(
    ...
    return new DeployedResourcesFullSnapshot(
