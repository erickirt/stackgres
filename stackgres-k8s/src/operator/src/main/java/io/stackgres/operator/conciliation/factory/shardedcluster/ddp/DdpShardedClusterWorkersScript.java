...
public class DdpShardedClusterWorkersScript implements ResourceGenerator<StackGresShardedClusterContext> {

  final LabelFactoryForShardedCluster labelFactory;

  @Inject
  public DdpShardedClusterWorkersScript(LabelFactoryForShardedCluster labelFactory) {
