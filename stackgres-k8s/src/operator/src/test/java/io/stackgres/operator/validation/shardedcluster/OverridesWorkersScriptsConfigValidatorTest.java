...
class OverridesWorkersScriptsConfigValidatorTest {

  private OverridesWorkersScriptsConfigValidator validator;

  @BeforeEach
  void setUp() {
    validator = new OverridesWorkersScriptsConfigValidator();
  }
