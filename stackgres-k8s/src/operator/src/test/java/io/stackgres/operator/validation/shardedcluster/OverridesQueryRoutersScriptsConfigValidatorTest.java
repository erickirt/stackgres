...
class OverridesQueryRoutersScriptsConfigValidatorTest {

  private OverridesQueryRoutersScriptsConfigValidator validator;

  @BeforeEach
  void setUp() {
    validator = new OverridesQueryRoutersScriptsConfigValidator();
  }
