...
class ShardedClusterWorkersDefaultInstanceProfileTest {
  ...
  private ShardedClusterWorkersDefaultInstanceProfile
      shardedClusterWorkersDefaultInstanceProfile;
  ...
  void setUp() {
    shardedClusterWorkersDefaultInstanceProfile =
        new ShardedClusterWorkersDefaultInstanceProfile(labelFactory, defaultProfileFactory);
  ...
  void generateResource_whenProfileEmpty_shouldGenerateDefault() {
    ...
    assertEquals(cluster.getSpec().getWorkers().getSgInstanceProfile(),
