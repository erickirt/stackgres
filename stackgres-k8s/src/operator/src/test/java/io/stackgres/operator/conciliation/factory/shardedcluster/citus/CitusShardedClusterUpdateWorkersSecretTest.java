...
class CitusShardedClusterUpdateWorkersSecretTest {
  ...
  private CitusShardedClusterUpdateWorkersSecret factory;

  private StackGresShardedCluster cluster;

  @BeforeEach
  void setUp() {
    factory = new CitusShardedClusterUpdateWorkersSecret(labelFactory);
    cluster = Fixtures.shardedCluster().loadDefault().get();
  }

  @Test
  void generateResource_whenTypeCitus_shouldGenerateSecret() {
  ...
  void generateResource_whenTypeCitus_shouldHaveCorrectName() {
    ...
    String expectedName =
        StackGresShardedClusterUtil.coordinatorScriptName(cluster) + "-update-workers";
  ...
  @Test
  void generateResource_whenTypeNotCitus_shouldNotGenerateSecret() {
