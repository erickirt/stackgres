...
class DdpShardedClusterUpdateWorkersSecretTest {
  ...
  private DdpShardedClusterUpdateWorkersSecret factory;

  private StackGresShardedCluster cluster;

  @BeforeEach
  void setUp() {
    factory = new DdpShardedClusterUpdateWorkersSecret(labelFactory);
