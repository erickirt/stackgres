...
class ShardedClusterWorkersDefaultPostgresConfigTest {
  ...
  private ShardedClusterWorkersDefaultPostgresConfig factory;

  private StackGresShardedCluster cluster;

  @BeforeEach
  void setUp() {
    factory = new ShardedClusterWorkersDefaultPostgresConfig(labelFactory, defaultFactory);
