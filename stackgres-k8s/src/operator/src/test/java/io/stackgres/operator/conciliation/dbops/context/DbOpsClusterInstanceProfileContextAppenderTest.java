...
class DbOpsClusterInstanceProfileContextAppenderTest {

  private DbOpsClusterInstanceProfileContextAppender contextAppender;
  ...
  void setUp() {
    ...
    contextAppender = new DbOpsClusterInstanceProfileContextAppender(
        profileFinder);
  }
