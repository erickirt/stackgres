...
class ShardedClusterWorkersPgBouncerDefaultPoolingConfigTest {
  ...
  private ShardedClusterWorkersPgBouncerDefaultPoolingConfig factory;

  private StackGresShardedCluster cluster;

  @BeforeEach
  void setUp() {
    factory = new ShardedClusterWorkersPgBouncerDefaultPoolingConfig(
