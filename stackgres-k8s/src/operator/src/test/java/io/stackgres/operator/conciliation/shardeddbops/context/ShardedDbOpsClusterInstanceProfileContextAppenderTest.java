...
class ShardedDbOpsClusterInstanceProfileContextAppenderTest {

  private ShardedDbOpsClusterInstanceProfileContextAppender contextAppender;
  ...
  void setUp() {
    ...
    contextAppender = new ShardedDbOpsClusterInstanceProfileContextAppender(
        profileFinder);
  }
