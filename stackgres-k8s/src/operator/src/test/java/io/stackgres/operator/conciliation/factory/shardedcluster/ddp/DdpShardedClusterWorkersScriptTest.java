...
class DdpShardedClusterWorkersScriptTest {
  ...
  private DdpShardedClusterWorkersScript factory;

  private StackGresShardedCluster cluster;

  @BeforeEach
  void setUp() {
    factory = new DdpShardedClusterWorkersScript(labelFactory);
  ...
  void generateResource_whenTypeDdp_shouldHaveCorrectName() {
    ...
    assertEquals(
        StackGresShardedClusterUtil.workersScriptName(cluster),
