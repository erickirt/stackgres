...
public class StackGresDbOpsPgbenchCustomScriptFrom {
  ...
  public boolean equals(Object obj) {
    ...
    if (!(obj instanceof StackGresDbOpsPgbenchCustomScriptFrom)) {
      return false;
    }
    StackGresDbOpsPgbenchCustomScriptFrom other = (StackGresDbOpsPgbenchCustomScriptFrom) obj;
