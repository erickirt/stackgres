...
public class StackGresStreamPodsScheduling {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(nodeAffinity, nodeSelector, podAffinity, podAntiAffinity, priorityClassName,
  ...
  public boolean equals(Object obj) {
    ...
    if (!(obj instanceof StackGresStreamPodsScheduling)) {
      return false;
    }
    StackGresStreamPodsScheduling other = (StackGresStreamPodsScheduling) obj;
