...
public class StackGresShardedDbOpsRestart {
  ...
  public boolean equals(Object obj) {
    ...
    if (!(obj instanceof StackGresShardedDbOpsRestart)) {
      return false;
    }
    StackGresShardedDbOpsRestart other = (StackGresShardedDbOpsRestart) obj;
