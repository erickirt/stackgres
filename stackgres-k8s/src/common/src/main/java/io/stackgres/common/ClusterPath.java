...
public enum ClusterPath implements EnvVarPathSource<StackGresCluster> {
  ...
  LOCAL_BIN_SETUP_IO_LIMITS_SH_PATH(LOCAL_BIN_PATH, "setup-io-limits.sh"),
  ...
  PATRONI_ENV_PATH(BASE_ENV_PATH, ClusterEnvVar.PATRONI_ENV.value()),
  PATRONI_SECRET_ENV_PATH(BASE_SECRET_PATH, ClusterEnvVar.PATRONI_ENV.value()),
  ...
  BACKUP_ENV_PATH(BASE_ENV_PATH, ClusterEnvVar.BACKUP_ENV.value()),
  BACKUP_SECRET_PATH(BASE_SECRET_PATH, ClusterEnvVar.BACKUP_ENV.value()),
  RESTORE_ENV_PATH(BASE_ENV_PATH, ClusterEnvVar.RESTORE_ENV.value()),
  RESTORE_SECRET_PATH(BASE_SECRET_PATH, ClusterEnvVar.RESTORE_ENV.value()),
  REPLICATION_INITIALIZATION_ENV_PATH(BASE_ENV_PATH, ClusterEnvVar.REPLICATION_INITIALIZATION_ENV.value()),
  REPLICATION_INITIALIZATION_SECRET_PATH(BASE_SECRET_PATH, ClusterEnvVar.REPLICATION_INITIALIZATION_ENV.value()),
  REPLICATE_ENV_PATH(BASE_ENV_PATH, ClusterEnvVar.REPLICATE_ENV.value()),
  REPLICATE_SECRET_PATH(BASE_SECRET_PATH, ClusterEnvVar.REPLICATE_ENV.value()),
  SSL_PATH("/etc/ssl"),
