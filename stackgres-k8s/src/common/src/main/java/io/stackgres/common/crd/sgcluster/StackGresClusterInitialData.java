...
public class StackGresClusterInitialData {
  ...
  public boolean equals(Object obj) {
    ...
    if (!(obj instanceof StackGresClusterInitialData)) {
      return false;
    }
    StackGresClusterInitialData other = (StackGresClusterInitialData) obj;
