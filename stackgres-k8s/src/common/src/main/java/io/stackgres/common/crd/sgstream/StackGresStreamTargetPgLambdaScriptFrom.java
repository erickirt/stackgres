...
public class StackGresStreamTargetPgLambdaScriptFrom {
  ...
  public boolean equals(Object obj) {
    ...
    if (!(obj instanceof StackGresStreamTargetPgLambdaScriptFrom)) {
      return false;
    }
    StackGresStreamTargetPgLambdaScriptFrom other = (StackGresStreamTargetPgLambdaScriptFrom) obj;
