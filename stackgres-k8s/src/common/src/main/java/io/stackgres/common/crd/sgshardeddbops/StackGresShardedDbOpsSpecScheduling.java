...
public class StackGresShardedDbOpsSpecScheduling {
  ...
  public boolean equals(Object obj) {
    ...
    if (!(obj instanceof StackGresShardedDbOpsSpecScheduling)) {
      return false;
    }
    StackGresShardedDbOpsSpecScheduling other = (StackGresShardedDbOpsSpecScheduling) obj;
