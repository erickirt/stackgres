...
public class StackGresShardedClusterWorkers extends StackGresClusterSpec {
  ...
  private List<@Valid StackGresShardedClusterWorker> overrides;
  ...
  public boolean isWorkersSupportingRequiredSynchronousReplicas() {
  ...
  public List<StackGresShardedClusterWorker> getOverrides() {
    return overrides;
  }

  public void setOverrides(List<StackGresShardedClusterWorker> overrides) {
  ...
  public int hashCode() {
    ...
    result = prime * result + Objects.hash(clusterNameTemplate, clusters, instancesPerCluster,
        overrides, replicationForWorkers);
    return result;
  }
  ...
  public boolean equals(Object obj) {
    ...
    if (!(obj instanceof StackGresShardedClusterWorkers)) {
      return false;
    }
    StackGresShardedClusterWorkers other = (StackGresShardedClusterWorkers) obj;
    return Objects.equals(clusterNameTemplate, other.clusterNameTemplate)
