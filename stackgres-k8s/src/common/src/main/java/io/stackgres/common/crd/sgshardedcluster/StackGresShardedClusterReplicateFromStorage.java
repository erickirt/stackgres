...
public class StackGresShardedClusterReplicateFromStorage {
  ...
  @NotEmpty(message = "paths is required")
  ...
  @Override
  public int hashCode() {
    return Objects.hash(paths, performance, sgObjectStorage);
  }
  ...
  public boolean equals(Object obj) {
    ...
    if (!(obj instanceof StackGresShardedClusterReplicateFromStorage)) {
      return false;
    }
    StackGresShardedClusterReplicateFromStorage other = (StackGresShardedClusterReplicateFromStorage) obj;
