...
public class StackGresStreamPodsPersistentVolume {
  ...
  public boolean equals(Object obj) {
    ...
    if (!(obj instanceof StackGresStreamPodsPersistentVolume)) {
      return false;
    }
    StackGresStreamPodsPersistentVolume other = (StackGresStreamPodsPersistentVolume) obj;
