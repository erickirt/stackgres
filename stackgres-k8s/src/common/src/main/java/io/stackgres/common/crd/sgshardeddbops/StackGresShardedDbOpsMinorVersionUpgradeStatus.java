...
public class StackGresShardedDbOpsMinorVersionUpgradeStatus extends ShardedDbOpsRestartStatus {
  ...
  public boolean equals(Object obj) {
    ...
    if (!(obj instanceof StackGresShardedDbOpsMinorVersionUpgradeStatus)) {
      return false;
    }
    StackGresShardedDbOpsMinorVersionUpgradeStatus other =
        (StackGresShardedDbOpsMinorVersionUpgradeStatus) obj;
