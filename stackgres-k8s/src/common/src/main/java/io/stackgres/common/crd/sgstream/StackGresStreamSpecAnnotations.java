...
public class StackGresStreamSpecAnnotations {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(allResources, pods, serviceAccount);
  }
  ...
  public boolean equals(Object obj) {
    ...
    if (!(obj instanceof StackGresStreamSpecAnnotations)) {
      return false;
    }
    StackGresStreamSpecAnnotations other = (StackGresStreamSpecAnnotations) obj;
