...
public class StackGresShardedClusterPostgresWorkersServices {
  ...
  public boolean equals(Object obj) {
    ...
    if (!(obj instanceof StackGresShardedClusterPostgresWorkersServices)) {
      return false;
    }
    StackGresShardedClusterPostgresWorkersServices other =
        (StackGresShardedClusterPostgresWorkersServices) obj;
