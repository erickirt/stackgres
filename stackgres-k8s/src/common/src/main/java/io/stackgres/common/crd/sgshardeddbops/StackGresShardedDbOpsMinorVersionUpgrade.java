...
public class StackGresShardedDbOpsMinorVersionUpgrade {
  ...
  public boolean equals(Object obj) {
    ...
    if (!(obj instanceof StackGresShardedDbOpsMinorVersionUpgrade)) {
      return false;
    }
    StackGresShardedDbOpsMinorVersionUpgrade other = (StackGresShardedDbOpsMinorVersionUpgrade) obj;
