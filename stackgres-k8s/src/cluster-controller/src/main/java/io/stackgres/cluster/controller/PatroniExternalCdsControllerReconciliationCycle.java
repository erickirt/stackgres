...
@ApplicationScoped
public class PatroniExternalCdsControllerReconciliationCycle
    extends
  ...
  public static class Parameters {
    ...
    @Inject
    PatroniExternalCdsControllerReconciliator reconciliator;
    @Inject
  ...
  @Inject
  public PatroniExternalCdsControllerReconciliationCycle(Parameters parameters) {
  ...
  public static PatroniExternalCdsControllerReconciliationCycle create(Consumer<Parameters> consumer) {
    ...
    return new PatroniExternalCdsControllerReconciliationCycle(parameters.findAny().get());
  }
